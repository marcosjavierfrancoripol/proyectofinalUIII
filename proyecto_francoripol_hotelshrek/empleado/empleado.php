                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1>registro del empleado</h1>
                                <form action="eminsertar.php" method="POST">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="emactualizar.php?id=<?php echo $row['id'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="emdelete.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
